...
function copyURL() {
  navigator.clipboard.writeText(store.ingestionURL)
}
  ...
  <div class="p-6 space-y-6 max-w-xl overflow-y-auto h-full">
    ...
    <section class="space-y-2">
      ...
      <div class="flex items-center gap-2">
        <code class="flex-1 text-xs bg-gray-50 border border-border rounded px-2 py-1.5 truncate">{{ store.ingestionURL }}</code>
